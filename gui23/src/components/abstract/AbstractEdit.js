...
class AbstractEdit extends Component {
    ...
    constructor() {
        super();
        this.state = { objects: [], hasErrors: false, errorMsg: false, newObjectName: '',  editObjectName: '', editPosition: 0 };
    }
    componentDidMount() {
    ...
    refresh() {
        fetchHandler(this.apiPath, null,(json) => this.setState({objects: json._embedded[this.listName]}), (json) =>  this.setState({errorMsg: json, hasErrors: true}))
    }
