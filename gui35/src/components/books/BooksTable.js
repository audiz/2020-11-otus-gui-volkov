...
class BooksTable extends Component {
    ...
    constructor() {
        super();
        this.state = {books: [], hasErrors: false, errorMsg: false, newObjectName: '',  editObjectName: '', editPosition: 0, [AUTHOR_LIST]: 0, [GENRE_LIST]: 0, loading: false };
    }
    ...
    refresh() {
        ...
        fetchHandler(this.apiPath, null,(json) => {
            if(json._embedded === undefined) {
                ...
                this.setState({books: json._embedded.bookList, loading: false })
            }
        ...
        return (
            <React.Fragment>
                ...
                <table className="table table-striped table-hover">
                    ...
                    <tbody>
                    {
                        this.state.loading ? "loading..." : this.state.books.map((book, i) => (
...
function EditRow(props) {
    return <tr>
        ...
        <td scope="row" style={{width: '20%'}}>
            <Select apiPath={"/api/authors"} listName={AUTHOR_LIST} selObj={props.book.author} callBack={props.callBack}/>
        </td>
        <td scope="row" style={{width: '20%'}}>
            <Select apiPath={"/api/genres"} listName={GENRE_LIST} selObj={props.book.genre} callBack={props.callBack}/>
        </td>
        <td scope="row"> </td>
        <td scope="row" style={{width: '10%'}}>
